...
public class sortingTests {
    //CONFIG
    private static final int COUNTREP = 6; //Anzahl Wiederholungen
    private static final int COUNTDATA = 50000000; //Anzahl Datensätze pro Wiederholung
    ...
    private static final boolean ENABLEMERGE = true; //Aktivierung Radix Sorting
    ...
    public static void testSetup(){
        ...
        System.out.println("Running Test with "+COUNTREP+" Repetitions");
        System.out.println("One repetition has "+COUNTDATA+ " entries");
        System.out.println("------------------------------------------------");
    }
    ...
    public void mergeTest(){
        if (ENABLEMERGE){
            double time = sort(unsorted, 5);
            success("Merge Sort", time);
        }
    }
